...
describe LabGroupsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "lab_groups", :action => "update", :id => "1").should == 
        {:path => "/lab_groups/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "lab_groups", :action => "destroy", :id => "1").should ==
        {:path => "/lab_groups/1", :method => :delete}
    end
  end
