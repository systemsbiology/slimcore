...
describe LabMembershipsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "lab_memberships", :action => "update", :id => "1").should ==
        {:path => "/lab_memberships/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "lab_memberships", :action => "destroy", :id => "1").should ==
        {:path => "/lab_memberships/1", :method => :delete}
    end
  end
